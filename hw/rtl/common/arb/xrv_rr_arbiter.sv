...
`TRACING_OFF
module xrv_rr_arbiter #(
    parameter NUM_REQS = 1,
    parameter MODEL    = 1,
    parameter LOG_NUM_REQS = `XM_LOG2UP(NUM_REQS),
    parameter LUT_OPT  = 0
) (
    input  logic                     clk_i,
    input  logic                     rst_i,
    input  logic [NUM_REQS-1:0]      requests,
    output logic [LOG_NUM_REQS-1:0]  grant_index,
    ...
    if (NUM_REQS == 1)  begin : g_passthru
        ...
        logic [LOG_NUM_REQS-1:0] grant_index_w;
        logic [NUM_REQS-1:0] grant_onehot_w;
        logic [LOG_NUM_REQS-1:0] state;
    ...
    `IGNORE_UNOPTFLAT_BEGIN
        logic [NUM_REQS-1:0] masked_pri_reqs, unmasked_pri_reqs;
    `IGNORE_UNOPTFLAT_END
        ...
        logic [NUM_REQS-1:0][LOG_NUM_REQS-1:0] grant_table;
        logic [LOG_NUM_REQS-1:0] state;
