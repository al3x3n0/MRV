...
module xrv_vx_execute import xrv_vx_gpu_pkg::*; #(
...
`endif
    ...
    xra_array #(
        ...
        ////////////////////////////////////////////////////////////////////////////////
        .vx_int_dispatch_if (dispatch_if[`EX_ALU * ISSUE_WIDTH_P +: ISSUE_WIDTH_P]),
        .vx_int_commit_if   (commit_if[`EX_ALU * ISSUE_WIDTH_P +: ISSUE_WIDTH_P]),
        .vx_branch_ctl_if   (branch_ctl_if)
        ////////////////////////////////////////////////////////////////////////////////
        .vx_lsu_dispatch_if (dispatch_if[`EX_LSU * ISSUE_WIDTH_P +: ISSUE_WIDTH_P]),
        .vx_lsu_commit_if   (commit_if[`EX_LSU * ISSUE_WIDTH_P +: ISSUE_WIDTH_P]),
        .vx_lsu_mem_if      (lsu_mem_if),
        ////////////////////////////////////////////////////////////////////////////////
`ifdef EXT_F_ENABLE
        .vx_fpu_dispatch_if (dispatch_if[`EX_FPU * ISSUE_WIDTH_P +: ISSUE_WIDTH_P]),
        .vx_fpu_commit_if   (commit_if[`EX_FPU * ISSUE_WIDTH_P +: ISSUE_WIDTH_P]),
...
`endif
    ...
    `endif
        .base_dcrs      (base_dcrs),
        .dispatch_if    (dispatch_if[`EX_SFU * ISSUE_WIDTH_P +: ISSUE_WIDTH_P]),
        .commit_if      (commit_if[`EX_SFU * ISSUE_WIDTH_P +: ISSUE_WIDTH_P]),
    `ifdef EXT_F_ENABLE
